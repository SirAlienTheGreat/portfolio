...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc33f000e16fa7656: (a: number, b: number) => void;
  readonly closure1918_externref_shim: (a: number, b: number, c: number) => void;
